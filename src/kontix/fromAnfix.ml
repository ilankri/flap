...
let fresh_cont_id : unit -> T.function_identifier = Util.Gensym.make "_K"
...
let translate (p : S.t) env =
  ...
  let fdefs = Util.ExtStd.List.flat_map translate_fun_def fdefs in
