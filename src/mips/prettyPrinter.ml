...
and instruction _ = function
  ...
  | Mul (r1, r2, r3) ->
      string "mul" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Div (r1, r2, r3) ->
      string "div" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Sub (r1, r2, r3) ->
      string "sub" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Add (r1, r2, r3) ->
      string "add" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Addiu (r1, r2, imm) ->
      string "addiu" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ immediate imm
  ...
  | Slt (r1, r2, r3) ->
      string "slt" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Sgt (r1, r2, r3) ->
      string "sgt" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Sge (r1, r2, r3) ->
      string "sge" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Sle (r1, r2, r3) ->
      string "sle" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3

  | Seq (r1, r2, r3) ->
      string "seq" ++ register r1
      ^^ comma ++ register r2
      ^^ comma ++ register r3
...
and register r =
  string
    (if Options.get_gcc () then Arch.Mips.string_of_register' r
     else Arch.Mips.string_of_register r)
